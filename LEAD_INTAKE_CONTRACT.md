...
**Status:** proposed (backend build pending) · **Version:** 1.0
...
| `company` | **honeypot** — a hidden field. Leave it in every form, empty. If a bot fills it, the lead is silently dropped |
